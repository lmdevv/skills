...
Write every skill with fewer words. Apply the writing rules below. Do not skip them.
...
Edit text to remove AI patterns and add human voice. Always remember when writing LESS IS MORE. The less text, the better. Keep it short and concise.
